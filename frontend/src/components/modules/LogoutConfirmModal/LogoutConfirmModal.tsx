...
const LogoutConfirmModal = ({ onClose, onYesConfirm, onNoConfirm }: Props) => {
  return (
    <ConfirmModal title="로그아웃" onClose={onClose}>
      <Typography fontSize="2.8rem">정말 로그아웃 하시겠습니까?</Typography>
